...
@Component({
  selector: 'app-home-orders-status',
  templateUrl: './home-orders-status.component.html',
  styleUrls: ['./home-orders-status.component.scss']
})
export class HomeOrdersStatusComponent {
  rows:any[] =
  [
    {
      "Client Request Order": "aaaa",
